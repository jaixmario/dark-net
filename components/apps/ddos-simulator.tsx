...
export function DdosSimulator() {
  const [targets, setTargets] = useState<Target[]>([
    { id: "t1", name: "E-commerce Website", ip: "104.18.22.164", type: "website", status: "online" },
    { id: "t2", name: "Banking Portal", ip: "198.51.100.65", type: "website", status: "online" },
    { id: "t3", name: "Cloud Server", ip: "203.0.113.42", type: "server", status: "online" },
    { id: "t4", name: "Government Website", ip: "192.0.2.18", type: "website", status: "online" },
    { id: "t5", name: "Corporate Network", ip: "172.16.254.1", type: "network", status: "online" },
    { id: "t6", name: "IoT Network", ip: "10.0.0.1", type: "iot", status: "vulnerable" },
  ])
  ...
  const [attacks, setAttacks] = useState<Attack[]>([
    ...
    },
    {
      id: "a4",
      name: "Ping of Death",
      description: "Sends malformed or oversized ping packets",
      power: 5,
      complexity: 2,
    },
    {
  ...
  const startAttack = () => {
    ...
    // Initial log
    addLog(`Starting ${selectedAttack.name} attack on ${selectedTarget.name} (${selectedTarget.ip})`, "info")
  ...
  const updateAttackStats = () => {
    ...
    if (targetLoad >= 95 && selectedTarget.status !== "offline") {
      ...
      addLog(`TARGET DOWN: ${selectedTarget.name} (${selectedTarget.ip}) is offline!`, "success")
    }
  }
    ...
    <div className="h-full flex flex-col bg-black p-3 text-green-500">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div className="text-lg font-bold flex items-center">
          ...
          <span>DDoS Attack Simulator</span>
        </div>
            ...
            <div className="p-2 space-y-2 max-h-[200px] overflow-auto">
              {targets.map((target) => (
                ...
                >
                  ...
                  <div className="text-xs text-green-500/70 mt-1">{target.ip}</div>
                </div>
              ))}
            </div>
          </div>
                ...
                >
                  <div className="flex justify-between">
                    ...
                    <div className="flex space-x-2">
                      <span className="text-xs">Power: {attack.power}/10</span>
                      <span className="text-xs">Complexity: {attack.complexity}/10</span>
                    </div>
                  </div>
              ...
              <div className="p-3">
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <div className="capitalize">{selectedTarget.type}</div>
                  </div>
                  <div>
